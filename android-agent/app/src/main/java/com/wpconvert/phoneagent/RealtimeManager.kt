            ...
            object : DataChannel.Observer {
                ...
                override fun onMessage(
                    ...
                    try {
                        ...
                        // Any remote interaction is treated as a wake-up
                        // action for the optional screen-dim feature.
                        MainActivity.restoreDimmedFromRemoteInput()

                        val command =
                            JSONObject(message)

                        // Sinkronkan nama phone yang diedit dari website.
                        // Pesan ini bukan command kontrol, jadi jangan diteruskan
                        // ke AccessibilityService.
                        if (command.optString("type") == "device_name") {
                            MainActivity.updateRemoteDeviceName(
