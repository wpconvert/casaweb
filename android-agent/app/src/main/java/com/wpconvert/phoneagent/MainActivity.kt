...
class MainActivity : Activity() {
    ...
    private fun buildUi() {
        ...
        val subtitle = TextView(this).apply {
            text = "Android agent untuk remote phone dashboard"
            textSize = 13f
            setTextColor(muted)
        ...
        status = TextView(this).apply {
            text = "Screen capture: TIDAK AKTIF"
            textSize = 14f
            setTextColor(text)
        ...
        val footer = TextView(this).apply {
            text = "WebRTC • Cloudflare Realtime • Secure device identity"
            textSize = 11f
    ...
    private fun actionButton(
        ...
        return Button(this).apply {
            ...
            background = buttonBackground(backgroundColor, accent)
